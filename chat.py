...
StatsRouter = tornadio2.router.TornadioRouter(PingConnection, dict(enabled_protocols=['websockets', 'xhr-polling','jsonp-polling', 'htmlfile'],websocket_check=True),namespace='stats')
